...
static void* memory_search_begin_callback(Thread* self, void* context) {
    ...
    uint8_t value_u8_min = MAX(round(value_f128_min), 0);
    uint16_t value_u16_min = MAX(round(value_f128_min), 0);
    uint32_t value_u32_min = MAX(round(value_f128_min), 0);
    uint64_t value_u64_min = MAX(round(value_f128_min), 0);
    int8_t value_i8_min = MAX(round(value_f128_min), INT8_MIN);
    int16_t value_i16_min = MAX(round(value_f128_min), INT16_MIN);
    int32_t value_i32_min = MAX(round(value_f128_min), INT32_MIN);
    int64_t value_i64_min = MAX(round(value_f128_min), INT64_MIN);
    flt32_t value_f32_min = value_f128_min;
    flt64_t value_f64_min = value_f128_min;
    flt128_t value_f128_max = value + deviation;
    uint8_t value_u8_max = MIN(round(value_f128_max), UINT8_MAX);
    uint16_t value_u16_max = MIN(round(value_f128_max), UINT16_MAX);
    uint32_t value_u32_max = MIN(round(value_f128_max), UINT32_MAX);
    uint64_t value_u64_max = MIN(round(value_f128_max), UINT64_MAX);
    int8_t value_i8_max = MIN(round(value_f128_max), INT8_MAX);
    int16_t value_i16_max = MIN(round(value_f128_max), INT16_MAX);
    int32_t value_i32_max = MIN(round(value_f128_max), INT32_MAX);
    int64_t value_i64_max = MIN(round(value_f128_max), INT64_MAX);
    flt32_t value_f32_max = value_f128_max;
